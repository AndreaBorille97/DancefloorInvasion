...
// CamperSpawner/RaverSpawner, non va messo su GameManager né su "floor"): ogni tot
// secondi, scelti a caso tra 1 e maxSpawnInterval, istanzia un AreaSoundWaveAmmo in un
// punto casuale sopra il pavimento (i confini della mappa sono letti dai bounds del
// Renderer di "floor").
public class AreaSoundWaveSpawner : MonoBehaviour
{
    [Header("Spawn")]
    [SerializeField] private GameObject ammoPrefab; // prefab dell'AreaSoundWaveAmmo da spawnare
