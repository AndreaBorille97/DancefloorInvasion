...
// secondi, scelti a caso tra 1 e maxSpawnInterval, istanzia un DeepSoundWaveAmmo in un
// punto casuale sopra il pavimento (i confini della mappa sono letti dai bounds del
// Renderer di "floor").
public class DeepSoundWaveSpawner : MonoBehaviour
{
    [Header("Spawn")]
    [SerializeField] private GameObject ammoPrefab; // prefab del DeepSoundWaveAmmo da spawnare
