...
// CamperSpawner/RaverSpawner/AreaSoundWaveSpawner/DeepSoundWaveSpawner/DrugSpawner, non va
// messo su GameManager né su "floor"): ogni tot secondi, scelti a caso tra 1 e
// maxSpawnInterval, istanzia un SoundSystemAmmo in un punto casuale sopra il pavimento
// (i confini della mappa sono letti dai bounds del Renderer di "floor").
public class SoundSystemAmmoSpawner : MonoBehaviour
{
    [Header("Spawn")]
    [SerializeField] private GameObject ammoPrefab; // prefab del SoundSystemAmmo da spawnare
